...
// DELETE /api/properties/:id - 5-17-2024
export const DELETE = async (request, { params }) => {
  try {
    ...
    // Check for session(if user is logged in)
    ...
    // Verify ownership(property owner)
...
// 5-18-2024 - PUT /api/properties/:id
export const PUT = async (request, { params }) => {
  try {
    ...
    // 5-18-2024 - Destructure property Id from params
    const { id } = params;
    ...
    // 5-18-2024 - Update property in database
